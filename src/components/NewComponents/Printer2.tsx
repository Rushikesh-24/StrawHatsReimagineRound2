...
function Printer2() {
  return (
    <div data-scroll-section className='h-screen relative will-change-transform flex justify-center items-center'>
        ...
        <p className={`${bebas.className} absolute lg:text-[90rem] md:text-[70rem] sm:text-[50rem] text-[40rem] text-[#720A0B] rotate-90 z-10 opacity-70 pointer-events-none`}>N</p>
        <div data-scroll data-scroll-speed={2} className='bg-red-canon hidden md:block absolute left-[8%] top-[10%] group'>
            ...
            />
            <p className='text-white z-10 left-[5%] bottom-[2%] -mt-10 absolute opacity-0 duration-500 group-hover:opacity-100'>Canon Pixma</p>
        </div>
        <div data-scroll data-scroll-speed={1} className='bg-red-canon absolute bottom-[5%] right-[10%] group'>
            <Image 
                ...
                className=' !mix-blend-color-burn object-contain'
            />
            <p className='text-white z-10 right-[5%] bottom-[2%] -mt-10 absolute opacity-0 duration-500 group-hover:opacity-100'>Wireless Printing</p>
        </div>
        <div className='text-[6rem] md:text-[18rem] font-normal z-10 relative'>
            <p className='text-4xl absolute top-[-10%] md:top-[2%] right-[10%] font-bebas'>VIVID EXPRESSIONS</p>
            ...
            <p className='text-4xl absolute bottom-[-10%] md:bottom-[10%] left-[5%] font-bebas'>BRIGHT COLORS</p>
        </div>
    </div>
  )
}

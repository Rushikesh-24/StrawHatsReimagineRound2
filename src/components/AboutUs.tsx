...
const AboutUs: React.FC<AboutUsProps> = ({ data }) => {
  ...
  return (
    <div
      className={`w-screen h-screen ${silkScreen.className}`}
    >
      <div
        ref={ref}
        className="w-full h-screen overflow-y-auto overflow-x-hidden relative"
      >
        <div className="w-full h-[400vh] flex flex-col justify-center items-center relative z-20 bg-yellow-300">
          <motion.div className="fixed pointer-events-none top-0 left-0 w-full h-screen flex justify-center items-center bg-white">
            <motion.div
              ...
              style={{
                width:
                  currentIndex >= 3 ? "100vw" : "75%",
                height:
                  currentIndex >= 3 ? "100vh" : "66.666667%",
                borderRadius:
                currentIndex >= 3 ? "0" : "3rem",
                justifyContent:
                currentIndex >= 3 ? "center" : "space-around",
            ...
            >
              ...
              <motion.div
                className="absolute bg-white transition-all  ease-in-out mix-blend-difference w-1/3 h-10 -right-20 top-[35%] z-50"
                ...
                style={{
                  mixBlendMode:
                  currentIndex > 1 ? currentIndex > 2?"color" :"lighten" : "difference",
                  display:
                  currentIndex>2?"hidden":"flex"
                }}
                
              />
              <motion.div
                className="absolute transition-all  ease-in-out bg-white mix-blend-difference w-1/3 h-10 -left-20 bottom-40 z-50"
              ...
              />
              {currentIndex>2 &&
              <motion.div className="bg-white w-full h-1/2 absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2"
              initial={{opacity: 0.7,width:"20%",height:"50%"}}
              animate={{opacity: 1,width:"100%",height:currentIndex>3?"100%":"50%"}}

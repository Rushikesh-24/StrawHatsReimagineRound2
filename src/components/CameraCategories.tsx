  ...
  return (
    <div data-scroll-section className='h-screen w-screen relative grid grid-cols-5 border-t border-b border-white overflow-hidden'>
        ...
        <div className='col-span-5 md:col-span-3 flex flex-col md:flex-row md:border-l-[20px] border-white h-screen'>
          <div className='bg-[#8d2a25] h-screen flex-1 duration-500 md:first-drawer relative flex items-start pt-10 overflow-hidden group'>
            <p className='md:absolute right-10 text-4xl md:text-[6.5rem] md:[writing-mode:vertical-rl]'>
              Interchangeable <br />
              <span className='text-xl md:text-4xl md:absolute bottom-5'>lens camera</span>
            </p>
            <Pic2 />
          </div>
          <div className='bg-[#71221e] h-screen flex-1 duration-500 md:second-drawer relative flex items-start pt-10 overflow-hidden'>
            <p className='md:absolute right-10 text-4xl md:text-[6.5rem] md:[writing-mode:vertical-rl]'>
              Digital <br />
              <span className='text-xl md:text-4xl md:absolute bottom-5 uppercase'>lens camera</span>
            </p>
          </div>
          <div className='bg-[#611a16] h-screen flex-1 duration-500 md:third-drawer relative flex items-start pt-10 overflow-hidden'>
            <p className='md:absolute right-10 text-4xl md:text-[6.5rem] md:[writing-mode:vertical-rl] uppercase'>
              LENSES <br />
              <span className='text-xl md:text-4xl md:absolute bottom-5'>AND ACCESSORIES</span>
            </p>
          </div>
        </div>
    </div>
